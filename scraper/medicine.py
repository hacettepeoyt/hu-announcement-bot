...
class Medicine:
    ...
    def __complete_url(text):
        ...
        if text[:4] == 'http' or text[:3] == 'www':
            ...
            url = 'http://www.tip.hacettepe.edu.tr/tr' + text
    ...
    def get_announcement(self):
        ...
        r = requests.get('http://www.tip.hacettepe.edu.tr/tr')
        r.encoding = 'utf-8'
        html_text = r.text
        ...
        with open('announcements.json') as file:
            ...
            lastAnnouncementFromDB = oldAnnouncements['Medicine'][0]

        if lastAnnouncementFromDB != self.announcement:
            with open('announcements.json', 'w', encoding='utf-8') as f:
                oldAnnouncements['Medicine'][0] = self.announcement
